...
| [`slim-cross-transport/`](slim-cross-transport/README.md) | Browser + native cross-transport demo: WebSocket and gRPC participants on one SLIM node using `@agntcy/slim-bindings-react-native` WASM bindings (npm) | SLIM, TypeScript, Vite, WebAssembly |
